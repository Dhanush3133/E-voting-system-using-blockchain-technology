...
const Details: React.FC<{ poll: PollStruct }> = ({ poll }) => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-[47px] font-[600px] text-center leading-none text-black">{poll.title}</h1>
        <p className="text-[16px] font-[500px] text-center text-black">{poll.description}</p>
        ...
        <div className=" h-[136px] gap-[16px] flex flex-col items-center mt-4">
          ...
          >
            <p className="text-[14px] font-[500px] text-center md:text-[16px] text-black">
          ...
          <div
            className="flex items-center justify-center w-[133px] h-[32px]
                 py-[20px] rounded-[10px] gap-[12px] text-black"
          >
          ...
          <div className="h-[36px] gap-[4px] flex justify-center items-center">
            <button
              ...
              rounded-full text-[12px] md:text-[16px] text-black"
            >
              {poll.votes} votes
            </button>
            ...
            <button
              ...
              border border-gray-400 bg-white bg-opacity-20 rounded-full text-[12px] md:text-[16px] text-black"
            >
            ...
            {wallet && wallet === poll.director && poll.votes < 1 && (
              ...
              text-[12px] md:text-[16px] gap-[8px] flex justify-center items-center text-black"
          ...
          {poll.votes < 1 && (
            <button
              ...
              border border-gray-400 bg-white hover:bg-opacity-20 hover:text-black py-2"
